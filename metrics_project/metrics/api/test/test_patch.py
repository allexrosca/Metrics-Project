...
class InfoTestCase(APITestCase):
    ...
    # --- NOT AUTHENTICATED ---
    def test_patch_item_not_auth(self):
    ...
    # --- AUTHENTICATED ---
    def test_patch_item_auth(self):
        data = {'category': 'second',
                'value': -3.451,
                'date': datetime.date(2424, 1, 1),
                'tags':'added, tags, here part 2',
                'time': '5:30 AM'
                }
    ...
    def test_patch_item_auth_removing_tags(self):
        data = {'category': 'second',
                'value': 21,
                'date': datetime.date(2000, 1, 1),
                'tags':'',
    ...
    def test_patch_item_auth_wrong_date_format(self):
        data = {'category': 'second',
                'value': 21,
                'date': '23-23-2000',
                'tags': 'randomTag',
    ...
    def test_patch_item_auth_wrong_time_format(self):
        data = {'category': 'second',
                'value': 21,
                'date': datetime.date(2000, 1, 1),
                'tags': 'randomTag',
    ...
    def test_patch_item_auth_not_existing_category(self):
        data = {'category': 'nope',
                'value': 21,
                'date': datetime.date(2000, 1, 1),
                'tags': 'randomTag',
    ...
    def test_patch_item_different_user(self):
        data = {'category': 'random',
                'value': 10.213123,
                'date': datetime.date(2050, 10, 10),
                'tags':json.dumps('other user'),
                'time': '5:30 AM'
                }
